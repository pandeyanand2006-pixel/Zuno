...
export async function Home() {
  ...
  // ── TRUST — high-visibility SVG icons (fixes invisible ↺/◧/◐ emojis)
  function trustIcon(type){
    const svgBase = { width:'20', height:'20', viewBox:'0 0 24 24', fill:'none', stroke:'currentColor', 'stroke-width':'2', 'stroke-linecap':'round', 'stroke-linejoin':'round', style:'display:block' };
    if(type==='fabric') return h('svg', svgBase, h('path', { d:'M3 5l9-2 9 2-9 2-9-2z' }), h('path', { d:'M3 12l9 2 9-2' }), h('path', { d:'M3 19l9 2 9-2' }), h('path', { d:'M12 7v14' }));
    if(type==='return') return h('svg', svgBase, h('path', { d:'M17 1l4 4-4 4' }), h('path', { d:'M3 11V9a4 4 0 014-4h14' }), h('path', { d:'M7 23l-4-4 4-4' }), h('path', { d:'M21 13v2a4 4 0 01-4 4H3' }));
    if(type==='secure') return h('svg', svgBase, h('rect', { x:'3', y:'11', width:'18', height:'11', rx:'2' }), h('path', { d:'M7 11V7a5 5 0 0110 0v4' }), h('circle', { cx:'12', cy:'16', r:'1.2', fill:'currentColor', stroke:'none' }));
    return h('svg', svgBase, h('path', { d:'M12 21s-6-4.3-6-10a6 6 0 0112 0c0 5.7-6 10-6 10z' }), h('circle', { cx:'12', cy:'11', r:'2.2' }));
  }
  const trust = h('section', { class: 'trust-grid', style: { maxWidth: '1320px', margin: '32px auto', padding: '20px', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', textAlign: 'center', borderTop: '1px solid var(--light-indigo)', borderBottom: '1px solid var(--light-indigo)' } },
    h('div', {}, h('div', { style: { width:'44px', height:'44px', borderRadius:'50%', background:'#E9EEF5', border:'1px solid #d6deee', color:'#0f172a', display:'grid', placeItems:'center', margin:'0 auto' } }, trustIcon('fabric')), h('div', { style: { fontWeight: '700', fontSize: '13px', marginTop: '8px', color:'#0f172a' } }, 'Premium fabric'), h('div', { style: { fontSize: '12px', color: 'var(--ink-500)' } }, '240 GSM heavyweight')),
    h('div', {}, h('div', { style: { width:'44px', height:'44px', borderRadius:'50%', background:'#E9EEF5', border:'1px solid #d6deee', color:'#0f172a', display:'grid', placeItems:'center', margin:'0 auto' } }, trustIcon('return')), h('div', { style: { fontWeight: '700', fontSize: '13px', marginTop: '8px', color:'#0f172a' } }, 'Easy returns'), h('div', { style: { fontSize: '12px', color: 'var(--ink-500)' } }, '7-day hassle-free')),
    h('div', {}, h('div', { style: { width:'44px', height:'44px', borderRadius:'50%', background:'#E9EEF5', border:'1px solid #d6deee', color:'#0f172a', display:'grid', placeItems:'center', margin:'0 auto' } }, trustIcon('secure')), h('div', { style: { fontWeight: '700', fontSize: '13px', marginTop: '8px', color:'#0f172a' } }, 'Secure payments'), h('div', { style: { fontSize: '12px', color: 'var(--ink-500)' } }, 'Razorpay protected')),
    h('div', {}, h('div', { style: { width:'44px', height:'44px', borderRadius:'50%', background:'#E9EEF5', border:'1px solid #d6deee', color:'#0f172a', display:'grid', placeItems:'center', margin:'0 auto' } }, trustIcon('india')), h('div', { style: { fontWeight: '700', fontSize: '13px', marginTop: '8px', color:'#0f172a' } }, 'Made in India'), h('div', { style: { fontSize: '12px', color: 'var(--ink-500)' } }, 'Designed with care')));
